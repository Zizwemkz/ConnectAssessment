    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbSettlementTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tbSettlementTransactions_tbCustomers_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbSettlementTransactions_CustomerId",
                table: "tbSettlementTransactions",
                column: "CustomerId");
        }
